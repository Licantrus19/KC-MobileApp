...
export const Util = {
    ...
    getRatingLimits(age: number, testType: string, result: number) {
        if (age < 27) {
            switch (testType) {
                case 'communication': return { one: 25.17, second: 35.5 };
                case 'fine_motor': return { one: 38.07, second: 43 };
                case 'gross_motor': return { one: 35.16, second: 44 };
                case 'individual_social': return { one: 29.79, second: 39.5 };
                case 'problem_solving': return { one: 31.54, second: 41.5 };
            }
        }
        else {
            if (age < 30) {
                switch (testType) {
                    ...
                    case 'fine_motor': return { one: 28.01, second: 39.5 };
                    case 'gross_motor': return { one: 18.42, second: 31.5 };
                    case 'individual_social': return { one: 27.62, second: 39.5 };
                    case 'problem_solving': return { one: 25.31, second: 36.0 };
                }
            }
            else {
                if (age < 33) {
                    switch (testType) {
                        ...
                        case 'fine_motor': return { one: 36.14, second: 44.5 };
                        case 'gross_motor': return { one: 19.25, second: 34.5 };
                        case 'individual_social': return { one: 27.08, second: 38.5 };
                        case 'problem_solving': return { one: 32.01, second: 42.0 };
                    }
                }
                else {
                    if (age < 36) {
                        switch (testType) {
                            ...
                            case 'fine_motor': return { one: 34.80, second: 44.5 };
                            case 'gross_motor': return { one: 12.28, second: 26.5 };
                            case 'individual_social': return { one: 26.92, second: 38.0 };
                            case 'problem_solving': return { one: 28.96, second: 39.0 };
                        }
                    }
                    else {
                        if (age < 42) {
                            switch (testType) {
                                ...
                                case 'fine_motor': return { one: 36.99, second: 45.5 };
                                case 'gross_motor': return { one: 18.07, second: 33.5 };
                                case 'individual_social': return { one: 30.29, second: 41.5 };
                                case 'problem_solving': return { one: 35.33, second: 44.5 };
                            }
                        }
                        else {
                            if (age < 48) {
                                ...
                                if (age < 54) {
                                    switch (testType) {
                                        ...
                                        case 'fine_motor': return { one: 32.78, second: 43.0 };
                                        case 'gross_motor': return { one: 15.81, second: 30.5 };
                                        case 'individual_social': return { one: 31.30, second: 41.5 };
                                        case 'problem_solving': return { one: 26.60, second: 38.5 };
                                    }
                                }
                                else {
                                    if (age < 60) {
                                        switch (testType) {
                                            ...
                                            case 'fine_motor': return { one: 35.18, second: 44.8 };
                                            case 'gross_motor': return { one: 17.32, second: 31.5 };
                                            case 'individual_social': return { one: 28.12, second: 39.5 };
                                            case 'problem_solving': return { one: 32.33, second: 43.5 };
                                        }
                                    }
                                    else {
                                        if (age < 64) {
                                            switch (testType) {
                                                ...
                                                case 'fine_motor': return { one: 31.28, second: 44.5 };
                                                case 'gross_motor': return { one: 26.54, second: 38.5 };
                                                case 'individual_social': return { one: 29.99, second: 41.5 };
                                                case 'problem_solving': return { one: 39.07, second: 46.4 };
                                            }
                                        }
                                        else {
                                            return require('../../screens/kids/test/test_questions/60_months/communication.json');
